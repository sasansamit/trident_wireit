		...
		modules: [

			{
				...
				"fields": [
					...
					{"type": "type", "inputParams": {"label": "Source", "name": "source", "wirable": false, "id": "workfl", typeInvite: "String" }}
				],
				"terminals": [
					{"name": "in", "direction": [0,1], "alwaysSrc":"true",  "offsetPosition": {"right": -15, "top": 22}, "ddConfig": {"type": "pipeIn","allowedTypes": ["pipeIn"]}}
				]
				}
			},
			{
				...
				"container": {
					...
					"title": "Each",
				"fields": [
					{"type": "type", "inputParams": {"label": "Label", "name": "name", "wirable": false, "id": "label" }},
					{"type": "text", "inputParams": {"label": "Code", "name": "code", "wirable": false, "rows":"5", "cols":"30", "id":"workfl", typeInvite: "function" }}
				],
				"terminals": [
					{"name": "output", "direction": [0,1], "alwaysSrc":"true", "offsetPosition": {"right": -15, "top": 50}, "ddConfig": {"type": "pipeIn","allowedTypes": ["pipeIn"]}, "nMaxWires": 10},
					//{"name": "output1", "direction": [0,-1], "alwaysSrc":"true", "offsetPosition": {"left": -15, "top": 12}, "ddConfig": {"type": "pipeOut","allowedTypes": ["pipeIn"]}},
					{"name": "input", "direction": [0,1], "offsetPosition": {"left": -15, "top": 50}, "ddConfig": {"type": "pipeIn","allowedTypes": ["pipeIn"]}}
				]
				}
			},

			{
				...
				"terminals": [
					{"name": "output", "direction": [0,1], "alwaysSrc":"true", "offsetPosition": {"right": -15, "top": 15}, "ddConfig": {"type": "pipeIn","allowedTypes": ["pipeIn"]}, "nMaxWires": 10},
					//{"name": "output1", "direction": [0,-1], "alwaysSrc":"true", "offsetPosition": {"left": -15, "top": 12}, "ddConfig": {"type": "pipeOut","allowedTypes": ["pipeIn"]}},
					{"name": "input", "direction": [0,1], "offsetPosition": {"left": -15, "top": 15}, "ddConfig": {"type": "pipeIn","allowedTypes": ["pipeIn"]}}
				]
				}
			},
